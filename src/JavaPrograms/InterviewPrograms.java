...
public class InterviewPrograms {
	...
	public static void replaceDigitsWithLetters() {

		String original = "Autom1234n";
		String digitsToReplace = "1234";
		String replacement = "atio";

		// Replace the digits with the replacement string
		String result = original.replace(digitsToReplace, replacement);
